...
class BluetoothTester(EnlightenPluginBase):
    ...
    def get_configuration(self):
        ...
        self.field(name="Power Watchdog Sec",    datatype=int,        callback=self.power_watchdog_sec, default=0, minimum=0, maximum=600)
        self.field(name="Laser Warning Sec",     datatype=int,        callback=self.laser_warning_delay_sec, default=2, minimum=0, maximum=10)
        self.field(name="Laser TEC Mode",        datatype="combobox", callback=self.laser_tec_mode, choices=BLEDevice.LASER_TEC_MODES.values())
    ...
    def change_setting(self, setting, value):
        ...
        if spec:
            spec.change_setting(setting, value)
