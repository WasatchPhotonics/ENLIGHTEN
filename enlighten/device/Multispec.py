...
class Multispec:
    ...
    def __init__(self, ctl):
        ...
        self.eject_button       .setWhatsThis("Disconnect this spectrometer from software, such that ENLIGHTEN will no longer communicate with it until the program is re-launched or the device is re-enumerated")
