...
class VCRControls:
    ...
    def __init__(self, ctl):
        ...
        self.bt_pause           .setWhatsThis("VCR-style pause button to freeze on-screen spectra (spectrometer silently continues free-running acquisition in background, but new spectra are neither displayed nor saved)")
        ...
        self.bt_step            .setWhatsThis("Take a single measurement, then resume pause. (only available when paused)")
        self.bt_step_save       .setWhatsThis("Take a single measurement, saving it to disk and the Clipboard, then resume pause. (only available when paused)")
