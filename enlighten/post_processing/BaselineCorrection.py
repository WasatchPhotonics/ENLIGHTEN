...
class BaselineCorrection:
    ...
    def __init__(self, ctl):
        ...
        for widget in [ self.cb_enabled, self.cb_show_curve, self.combo_algo ]:
            widget.setWhatsThis(unwrap("""
                Baseline correction allows you to select one of several 3rd-party
                ...
                Although multiple algorithms are provided for your experimentation,
                Wasatch recommends AirPLS for use with Raman spectroscopy.

                You can optionally check the "show curve" option to see the 
                computed baseline as generated by each of the different 
                baseline algorithms.

                If you have a better (open-source) baseline-correction algorithm
                you'd like to see supported in ENLIGHTEN, please contact us!"""))
