...
- 2026-08-19 4.2.9
    ...
    - XD
        ...
        - prompt to interpolate at export
        - improved XD exports
        - added ctrl-I shortcut to toggle Interpolation
    - XL
        - stomp detector with string generated by Andor SDK
        - add to Fingerprint and Functional model families
        - support bad_pixels in JSON file
    - XS
        - support bad_pixels over BLE
    - XD
        - always allow in Expert Mode (regardless of laser)
        - prompt to interpolate at export (CSV-only, XD-only or interpolated)
...
- 2026-08-06 4.2.8
    ...
    - JSON export fixes
- 2026-08-06 4.2.7
    - add ResourceMonitor profiling around XD import, load and execution
...
- 2026-05-27 4.2.2
    ...
    - XDFeature
        - This was a major goal of this release, to promote XD from 
        ...
        - show both raw and XD on shared clipboard thumbnail
...
- 2026-04-16 4.2.1
    - Bluetooth
        ...
        - fixed RESET_UNIT
        - numerous other BLEDevice improvements from Wasatch.P6Y 2.3.23
- 2026-04-10 4.2.0
...
- 2026-01-12 4.1.35
    - improved support for using 220250 as laser driver (no spectra)
- 2025-12-18 4.1.34
    - display cursor in Area Scan
    - infrastructure to support laser PIN on XS
- 2025-12-10 4.1.33
